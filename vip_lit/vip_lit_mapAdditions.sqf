...
vip_lit_var_cl_mapRainTypes = [
	_missionRoot + "vip_lit\resource\drop1.paa",
	_missionRoot + "vip_lit\resource\drop2.paa",
	_missionRoot + "vip_lit\resource\drop3.paa",
	_missionRoot + "vip_lit\resource\drop4.paa",
	_missionRoot + "vip_lit\resource\drop5.paa",
	_missionRoot + "vip_lit\resource\drop6.paa",
	_missionRoot + "vip_lit\resource\drop7.paa"
];
...
vip_lit_var_cl_mapFlashlightTex = _missionRoot + "vip_lit\resource\flashlight.paa";
...
vip_lit_eh_cl_drawFlashlight = (findDisplay 12 displayCtrl 51) ctrlAddEventHandler ["Draw", {
	...
	_sizeBeam = _size / vip_lit_var_cl_mapFlashlightScale; if (_mapZoom < 0.2) then {_sizeBeam = _sizeBeam / (_mapZoom * (1 / 0.2))};
