...
private ["_position_mark","_radarray","_campmark","_unit_type","_locselname","_wside","_rnum","_wGrp","_pow","_VarName","_veh_name","_tsk","_taskdesc","_trig2cond","_trig2act","_trg1"];
