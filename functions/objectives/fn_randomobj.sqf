...
#define _enemy_vehicles (5 + round(random 3))

if (count playableunits < 8) then {

	//#define _enemy_house [30,20]
...
if ((toLower _locselname isEqualTo "kavala") or (toLower _locselname isEqualTo "aggelochori")) then {
...
[_locselpos,800,15,false,_ghst_side,[false,"ColorBlack"]] call ghst_fnc_mines;
...
ghst_randomobjectives = [_locselpos,[_area_size,_area_size],_PARAM_Tasks,(getmarkerpos "pow_rescue"),_locselname] spawn ghst_fnc_randomobjectives;
