...
private ["_position_mark","_radarray","_obj","_dropoff_point","_locselname","_markunitsarray","_markunits","_mcolor","_msize","_sideguards","_rnum","_tsk","_menlist","_staticlist","_vehlist","_vehsel","_crew","_spawnpos","_temppos","_veh","_veh_name","_VarName","_vehpos","_pos","_mark1","_eGrp","_armor1","_g","_tasktopic","_taskdesc","_trig1stat","_trig1act","_trg1","_mass"];
...
while {true} do {
	...
	_spawnpos = _temppos findEmptyPosition[ 10 , 200 , _obj ];
	if (count _spawnpos > 1) exitwith {};
};

if (isnil "_spawnpos") then {
	_spawnpos = [_position_mark,[_radarray select 0, _radarray select 1, (random 360)]] call ghst_fnc_rand_position;
};
...
_trg1 setTriggerTimeout [10, 10, 10, true];
