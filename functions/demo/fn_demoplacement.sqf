...
private ["_explosive","_typecharge","_chargearray","_typemagazine","_expname","_obj","_unit","_curpos","_terrain","_stepsize","_range","_view_target","_eye_pos","_view_vec","_view_vec_length","_norm_view_vec","_steps","_i","_new_end_point","_objdir","_unitdir","_chargedir","_magcount","_dist","_trgt_name","_exppos"];
