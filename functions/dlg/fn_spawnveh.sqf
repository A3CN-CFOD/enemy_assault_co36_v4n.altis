/*
V2.4 Script by: Ghost (Original dialog from Kronzky) create a marker and name itand put this in the object initline - ghst_spawnveh = station1 addAction ["Spawn Vehicle", "spawn ghst_fnc_spawnveh", ["spawnmarker",dir,[vehicle list]], 6, true, true, "","alive _target"];
*/
...
_vehiclelist = _paramarray select 2;
