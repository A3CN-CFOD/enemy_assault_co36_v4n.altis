#define AFAR_sfx
#define AFAR titles[]={""};
class in0 {name="in0";sound[]={"@A3\Dubbing_Radio_F\sfx\in2a.ogg",db+7,1.1};AFAR};
class in1 {name="in1";sound[]={"@A3\Dubbing_Radio_F\sfx\in2a.ogg",db+5,1};AFAR};
class in2 {name="in2";sound[]={"@A3\Dubbing_Radio_F\sfx\in2a.ogg",db+5,.7};AFAR};
class out1 {name="out1";sound[]={"@A3\Dubbing_Radio_F\sfx\out2a.ogg",db+5,1};AFAR};
